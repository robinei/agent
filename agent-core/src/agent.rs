//! Context building, auto-titling, and token estimation.
//!
//! These are library functions used by the server (auto_title) and the
//! worker (build_context, estimate_*). The agent loop itself lives in
//! `agent-worker`.
